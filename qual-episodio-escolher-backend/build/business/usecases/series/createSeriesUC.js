...
class CreateSeriesUC {
    constructor(createSeriesDataSource, idGeneratorDataSource) {
        this.createSeriesDataSource = createSeriesDataSource;
    ...
    execute(input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newSerie = new serie_1.Serie(this.idGeneratorDataSource.generateId(), input.titulo, input.lancamento, input.sinopse, input.categoria);
            yield this.createSeriesDataSource.createSerie(newSerie);
        });
    }
}
